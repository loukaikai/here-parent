...
public class JsApiDTO {
    ...
    @ApiModelProperty(value = "appid", name = "应用ID", notes = "由微信生成的应用ID，全局唯一")
    private String appid;

    @ApiModelProperty(value = "mchid", name = "直连商户号", notes = "直连商户的商户号，由微信支付生成并下发")
    private String mchid;

    @ApiModelProperty(value = "description", name = "商品描述")
    private String description;

    @ApiModelProperty(value = "outTradeNo", name = "商户订单号", notes = "商户系统内部订单号，只能是数字、大小写字母_-*且在同一个商户号下唯一")
    ...
    @ApiModelProperty(value = "notifyUrl", name = "通知地址\t", notes = "异步接收微信支付结果通知的回调地址，" +
    ...
    @ApiModelProperty(value = "supportFapiao", name = "电子发票入口开放标识", notes = "传入true时，支付成功消息和支付详情页将出现开票入口。" +
